...
import client.nilore.modules.impl.world.ModuleBedAura;
...
public class RotationHandler
    ...
    public void onTickHigh(TickEvent tickEvent) {
        if (mc.player != null) {
            ...
            ModuleBedAura bedAura = ModuleBedAura.INSTANCE;
            ...
            Velocity antiKB = Velocity.INSTANCE;
            ...
            } else if (bedAura != null && bedAura.isEnabled() && bedAura.isPrioritized() && ModuleBedAura.targetRotation != null) {
                RotationHandler.setTargetRotation(ModuleBedAura.targetRotation);
            ...
            } else if (antiKB != null && antiKB.isEnabled() && Velocity.rotation != null) {
                RotationHandler.setTargetRotation(Velocity.rotation);
            } else if (bedAura != null && bedAura.isEnabled() && ModuleBedAura.targetRotation != null) {
                RotationHandler.setTargetRotation(ModuleBedAura.targetRotation);
            } else {
                isRotating = false;
            }
