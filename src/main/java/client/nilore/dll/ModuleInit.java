 ...
 * {@code INVOKESTATIC client/nilore/patch/ConnectionPatch.transformReceive}).
...
public final class ModuleInit {
    ...
    public static void load(String jarPath, ClassLoader gameLoader) throws Throwable {
        ...
        Class<?> bootstrapCls = Class.forName("client.nilore.dll.ClientInit", true, gameLoader);
