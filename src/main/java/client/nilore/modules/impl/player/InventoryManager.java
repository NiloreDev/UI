...
public class InventoryManager extends Module {
    ...
    private final ModeSetting offhandItemSetting = new ModeSetting("Offhand Items", "None", "GoldenApple", "Projectile", "FishingRod", "Block").withDefault("None");
    ...
    public String getSuffix() {
        String offhandValue = offhandItemSetting.getValue();
        if (offhandValue == null || offhandValue.isEmpty() || offhandValue.equals("None")) {
            return null;
        }
    ...
    public String getDisplayName() {
        String offhandValue = offhandItemSetting.getValue();
        if (offhandValue == null || offhandValue.isEmpty() || offhandValue.equals("None")) {
            return "§fInventoryManager";
        }
        return "§fInventoryManager[" + offhandValue + "]";
    }
