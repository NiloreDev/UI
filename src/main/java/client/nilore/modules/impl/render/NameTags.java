...
public class NameTags extends Module {
    ...
    public final BooleanSetting showHealthSetting = new BooleanSetting("Show Health", true);
    public final BooleanSetting showArmorSetting = new BooleanSetting("Show Armor", true);
    public final BooleanSetting showPingSetting = new BooleanSetting("Hide Teammates", false);

    // ===== 新增：目标类型开关 =====
    public final BooleanSetting showPlayersSetting = new BooleanSetting("Players", true);
    public final BooleanSetting showInvisiblePlayersSetting = new BooleanSetting("Invisible Players", true);
    public final BooleanSetting showMonstersSetting = new BooleanSetting("Monsters", false);
    public final BooleanSetting showAnimalsSetting = new BooleanSetting("Animals", false);
    public final BooleanSetting showItemsSetting = new BooleanSetting("Items", false);
    public final BooleanSetting showOtherEntitiesSetting = new BooleanSetting("Other Entities", false);
